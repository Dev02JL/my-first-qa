...
describe('API Tests', () => {
  ...
  // Nettoyer la base de données avant chaque test (seulement si pas en CI)
  beforeEach(async () => {
    if (!isCI) {
  ...
  afterAll(async () => {
    // Fermer la connexion MongoDB (seulement si pas en CI)
  ...
  // Tests pour la route /login (seulement si pas en CI)
  if (!isCI) {
    describe('POST /login', () => {
